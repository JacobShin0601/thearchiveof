...
The branching rule, Work authoring process, input brief, bilingual quality checks, and release checklist are documented in [`docs/EDITORIAL_WORKFLOW.md`](docs/EDITORIAL_WORKFLOW.md). English editions follow [`docs/editorial-localization.md`](docs/editorial-localization.md): preserve concepts and facts while adapting generic examples for NYC / Manhattan where useful. Start each article from [`docs/ARTICLE_BRIEF_TEMPLATE.md`](docs/ARTICLE_BRIEF_TEMPLATE.md). Agents and GitHub Copilot should follow [`AGENTS.md`](AGENTS.md). Retrieval and cost rules for crawlers are in [`docs/AGENT_ACCESS.md`](docs/AGENT_ACCESS.md). Credential-scanner WAF rules stay in the Cloudflare dashboard; the checklist is [`docs/CLOUDFLARE_WAF.md`](docs/CLOUDFLARE_WAF.md).
