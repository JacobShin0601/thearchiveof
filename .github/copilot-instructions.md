...
- Agents should be able to fetch and carry production articles. Do not source-block crawlers on Production. Do not let crawlers write reactions or events. Do not add SSR or Bot Fight Mode; static reads are the cheap path. See `docs/AGENT_ACCESS.md`.
